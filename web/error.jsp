...
<script type="text/javascript" src="js/bootstrap.js"></script> 
    ...
    <body  style="background-color: #f6f6f6;">
        <%! int u,r; Robject x;StringBuilder sb; String error;%>
        <% 
                    ...
                    <ul class="nav navbar-nav navbar-right" style="margin-right: 0px;">
                        ...
                        <li  class="navbar-btn" >
                            <button type="button" class="btn btn-danger " data-toggle="modal" data-target="#myModal" style="margin-right: 10px;"><span class="glyphicon glyphicon-user"></span> Sign up</button>
                                  ...
                                  <div class="well-sm text-center" style="padding: 0px;margin-top: 70px; "><h3 class="label label-success" style="font-size: 30px;margin-top: 30px;"><%=request.getAttribute("error")%></h3></div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form form-horizontal" method="post" action="signup">
                <div class="form-group">
                    <label for="fname" class="control-label col-md-3" required>First Name</label>
                    <div class="col-md-9">
                        <input type="text" name="fname"class="form-control" placeholder="First Name" id="fname" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="fname" class="control-label col-md-3" required>Last Name</label>
                    <div class="col-md-9">
