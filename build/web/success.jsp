   ...
   x.setBg("O+");
      ...
      <li><a href="#contact" class="x">Contact Us</a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right" style="margin-right: 0px;">
                            ...
                            <li class="navbar-brand">Welcome <%=request.getSession().getAttribute("name")%></li>
                            <a class="btn btn-danger navbar-btn" href="logout"><span class="glyphicon glyphicon-log-out"></span>Logout</a>
                        
                        
                    </ul>
                </div>
            </nav>
                            <div class="well-sm text-center" style="padding: 0px;margin-top: 70px; "><h3 class="label label-success" style="font-size: 30px;margin-top: 30px;"><%=request.getAttribute("msg")%></h3></div>
        ...
        <div class="container-fluid text-center" id="">
            ...
            <div class="col-md-6" >
                <div style="background-color: #e4e4e4;border-radius: 20px;height: 300px;padding: 20px;">
                    ...
                    <form class="form-horizontal" style="margin-top: 30px;margin-bottom: 30px;" method="post" action="reqservlet">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="city" class="control-label col-md-4" name="city">City</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="city" required="">
                        </div> 
                    </div>
                    <div class="form-group">
                        <label for="location" class="control-label col-md-4" name="location">Hospital/location</label>
                        <div class="col-md-8">
                                                    ...
                                                    <div style="background-color: #e4e4e4 ;padding: 50px;border-bottom-left-radius: 50px;border-top-right-radius: 50px; ">
                                                         ...
                                                         <div class="row" style="margin-top: 30px;">
                                                             ...
                                                             <div class="col-md-6" style="background-color: white;border-radius: 30px;padding: 20px;">
                                                                 <form method="post" action="ask" class="form-horizontal" style="margin-top: 30px;margin-bottom: 30px;">
                    <div class="form-group">
