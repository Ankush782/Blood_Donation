                                                    ...
                                                    <div style="background-color: #e4e4e4 ;padding: 50px;border-bottom-left-radius: 50px;border-top-right-radius: 50px; ">
                                                         ...
                                                         <div class="row" style="margin-top: 30px;">
                                                             ...
                                                             <div class="col-md-6" style="background-color: white;border-radius: 30px;padding: 20px;">
                                                                 <form action="ask" method="post" class="form-horizontal" style="margin-top: 30px;margin-bottom: 30px;">
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form form-horizontal">
                    <div class="form-group">
                    <label for="email" class="control-label col-md-3" name="email">Email</label>
                    <div class="col-md-9">
                        <input type="email" name="email" class="form-control">   
                    </div>
                </div>
                    <div class="form-group">
                    <label for="password" class="control-label col-md-3" name="password">Password</label>
                    <div class="col-md-9">
                        <input type="password" name="password" class="form-control">   
                    </div>
                </div>
